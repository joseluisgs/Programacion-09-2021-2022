...
class AcuerdoRepositoryTest {
    ...
    AcuerdoRepository acuerdosRepository = AcuerdoRepository.getInstance();
    ...
    void save() throws SQLException {
        var res = acuerdosRepository.save(acuerdoTest);
    ...
    void update() throws SQLException {
        ...
        var res = acuerdosRepository.update(acuerdoTest.getId(), acuerdoTest);
        Optional<Acuerdo> acuerdoOp = acuerdosRepository.findById(acuerdoTest.getId());
        assertAll(
                () -> assertEquals(res.getNombre(), acuerdoTest.getNombre()),
                () -> assertEquals(res.getLineas().size(), acuerdoTest.getLineas().size()),
    ...
    void delete() throws SQLException {
        ...
        var res = acuerdosRepository.delete(acuerdoTest.getId());
