...
public class PaisView {
    ...
    private final PaisController paisController = new PaisController(PaisRepository.getInstance());
    // No necesitamos hacer un singleton, o si...
    private final AcuerdoController acuerdoController = new AcuerdoController(AcuerdoRepository.getInstance());
    private final BackupManager backupManager = new BackupManager(
            PaisRepository.getInstance(),
            AcuerdoRepository.getInstance(),
            StorageBackupJsonFile.getInstance()
    );
