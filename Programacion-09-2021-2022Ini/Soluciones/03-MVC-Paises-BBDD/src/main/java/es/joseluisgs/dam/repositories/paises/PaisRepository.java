...
public class PaisRepository implements IPaisRepository {
     ...
     */
    @Override
    public Pais save(Pais pais) throws SQLException {
     ...
     */
    @Override
    public Pais update(Integer id, Pais pais) throws SQLException {
        ...
        DataBaseManager db = DataBaseManager.getInstance();
        db.open();
        db.update(query, pais.getNombre(), pais.getCodigo(), pais.getIdioma(), pais.getMoneda(),
     ...
     */
    @Override
    public Pais delete(Integer id) throws SQLException {
