...
public class PaisView {
    ...
    private final PaisController paisController = new PaisController(
            PaisRepository.getInstance(DataBaseManager.getInstance())
    );
    // No necesitamos hacer un singleton, o si...
    private final AcuerdoController acuerdoController = new AcuerdoController(
            AcuerdoRepository.getInstance(DataBaseManager.getInstance())
    );
