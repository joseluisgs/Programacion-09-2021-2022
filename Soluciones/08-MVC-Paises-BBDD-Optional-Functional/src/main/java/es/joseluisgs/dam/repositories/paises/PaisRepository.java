...
public class PaisRepository implements IPaisRepository {
    ...
    private PaisRepository(DataBaseManager dataBaseManager) {

        this.db = dataBaseManager;
    }

    public static PaisRepository getInstance(DataBaseManager dataBaseManager) {
        if (instance == null) {
            instance = new PaisRepository(dataBaseManager);
        }
        return instance;
    }
